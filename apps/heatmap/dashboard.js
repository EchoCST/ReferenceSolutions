...
if (Echo.Control.isDefined("Echo.Apps.HeatMap.Dashboard")) return;

var dashboard = Echo.Control.manifest("Echo.Apps.HeatMap.Dashboard");
...
dashboard.init = function() {
	...
	Echo.Polyfills.ECL.templateECL(self, "/heatmap/dashboard", deferreds[0].resolve);
};
