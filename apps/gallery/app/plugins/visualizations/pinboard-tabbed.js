...
/**
 * @class Echo.StreamServer.Controls.Stream.Item.Plugins.TabbedPinboardVisualization
 * The TabbedPinboardVisualization plugin transforms Stream.Item control into a
...
var plugin = Echo.Plugin.manifest("TabbedPinboardVisualization", "Echo.StreamServer.Controls.Stream.Item");
...
/**
 * @echo_event Echo.StreamServer.Controls.Stream.Item.Plugins.TabbedPinboardVisualization.onChangeView
...
plugin.css =
	...
	'.{plugin.class} .{class:content} { padding-bottom: 0px; margin: 0px 2% 15px 2%; background: #f0f0f0; }' +
...
/**
 * @class Echo.StreamServer.Controls.Stream.Plugins.TabbedPinboardVisualization
 * See Echo.StreamServer.Controls.Stream.Items.Plugins.TabbedPinboardVisualization
 * above for details.
 *
 * @extends Echo.Plugin
 */
var plugin = Echo.Plugin.manifest("TabbedPinboardVisualization", "Echo.StreamServer.Controls.Stream");
...
plugin.events = {
	...
	"Echo.StreamServer.Controls.Stream.Item.Plugins.TabbedPinboardVisualization.onChangeView": function(topic, args) {
		var plugin = this;
		if (args.force) {
			plugin._refreshView();
		} else {
